...
from .api.services_routes import services_routes
from .api.billings_routes import billings_routes
...
app.register_blueprint(billings_routes, url_prefix='/api/billings')
